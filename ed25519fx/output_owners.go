...
// OutputOwners describes who can spend an output locked with Ed25519 keys.
// Addrs are 20-byte short IDs derived from the 32-byte Ed25519 public keys
// via hash.PubkeyBytesToAddress (same address scheme as secp256k1fx).
...
// isSortedAndUniqueShortIDs checks if a slice of ShortIDs is sorted and unique
...
// sortShortIDs sorts a slice of ShortIDs lexicographically
